...
export default function ResultsPage() {
  ...
  useEffect(() => {
    ...
    if (!prefsParam) {
      router.push("/find-my-best-house");
      return;
    }
    ...
    return (
      <main className="min-h-screen bg-[var(--nexora-surface)] py-10">
        <div className="container-medium text-center">
          ...
          <Link href="/find-my-best-house" className="text-[var(--nexora-primary)] hover:underline">
    ...
    return (
      <main className="min-h-screen bg-[var(--nexora-surface)] py-10">
        <div className="container-medium text-center">
          ...
          <Link href="/find-my-best-house" className="mt-4 inline-block text-[var(--nexora-primary)] hover:underline">
            Adjust preferences
          </Link>
        </div>
      </main>
    ...
    <main className="min-h-screen bg-[var(--nexora-surface)] py-10">
      <div className="container-medium">
        ...
        <div className="mt-8 text-center">
          <Link
  href="/?openModal=true"
  className="text-sm text-[var(--nexora-primary)] hover:underline"
>
