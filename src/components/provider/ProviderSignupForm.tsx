  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      await setDoc(doc(db, "users", fbUser.uid), {
        ...
        // ─── Verification: new providers start as pending ───
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <button
        ...
        className="w-full rounded-xl bg-gradient-to-r from-blue-500 to-indigo-600 py-3.5 text-sm font-semibold text-white shadow-md transition-all hover:scale-[1.01] hover:shadow-lg active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:scale-100"
      >
        {isLoading ? (
